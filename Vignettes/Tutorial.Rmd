...
It will give you an output that includes the filtered dataframe as well as a summary of decisions made internally for transparency: number of plots that were auto-trimmed (had greater than specified number of visits), plots included due to manual override, and dropped plots that were trimmed/removed from the dataset. It will print the list of plots that were trimmed so you can review it and decide whether to include them in a re-run with additional manual override. 
